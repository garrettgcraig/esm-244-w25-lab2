...
- test that model against the test set with fitted training model
close loop
...
#replace allows the sample to recycle the pulled numbers (sampling with replacement)
```
